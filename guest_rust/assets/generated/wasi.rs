...
/// ## Parameters
///
/// * `stream` - Handle to the stream from which to read.
/// * `buf` - The buffer to which to write the input.
///
/// ## Return
///
/// The number of bytes placed in the buffer.
pub unsafe fn sf_read(stream: Fd, buf: *mut u8, buf_len: Size) -> Result<Size, Errno> {
    let mut rp0 = MaybeUninit::<Size>::uninit();
    let ret = superface_unstable::sf_read(
        stream as i32,
        buf as i32,
        buf_len as i32,
        rp0.as_mut_ptr() as i32,
...
/// ## Parameters
///
/// * `stream` - Handle to the stream to which to write.
/// * `buf` - The buffer from which to read the input.
///
/// ## Return
///
/// The number of bytes read from the buffer.
pub unsafe fn sf_write(stream: Fd, buf: *const u8, buf_len: Size) -> Result<Size, Errno> {
    let mut rp0 = MaybeUninit::<Size>::uninit();
    let ret = superface_unstable::sf_write(
        stream as i32,
        buf as i32,
        buf_len as i32,
        rp0.as_mut_ptr() as i32,
...
/// ## Parameters
///
/// * `stream` - Handle to the stream which to flush.
pub unsafe fn sf_flush(stream: Fd) -> Result<(), Errno> {
    let ret = superface_unstable::sf_flush(stream as i32);
    match ret {
        0 => Ok(()),
        _ => Err(Errno(ret as u16)),
    }
...
pub mod superface_unstable {
    #[link(wasm_import_module = "superface_unstable")]
    extern "C" {
        /// Read from a predefined stream.
        pub fn sf_read(arg0: i32, arg1: i32, arg2: i32, arg3: i32) -> i32;
        /// Write to a predefined stream.
        pub fn sf_write(arg0: i32, arg1: i32, arg2: i32, arg3: i32) -> i32;
        /// Flush a predefined stream.
        pub fn sf_flush(arg0: i32) -> i32;
    }
}
