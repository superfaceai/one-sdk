          ...
          __outcome.data = Object.assign(
            {},
            {
              sentiment: (() => {
                const acc = [];
                {
                  const outcome = MapScoreToSentiment(
                    Object.assign(
                      {},
                      {
                        score: (() => {
...
function MapScoreToSentiment(args, parameters, security) {
  const __outcome = { data: undefined, error: undefined };
  let vars = {};
  FN_BODY: {
    vars = Object.assign(vars, { result: 'neutral' });
    vars = Object.assign(vars, { result: 'negative' });
    vars = Object.assign(vars, { result: 'positive' });
    __outcome.data = (() => {
      with (vars) {
        return result;
      }
